namespace CodyMVC5HomeWork1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶資料數清單Repository Get客戶資料數清單Repository()
		{
			var repository = new 客戶資料數清單Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶資料數清單Repository Get客戶資料數清單Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶資料數清單Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
